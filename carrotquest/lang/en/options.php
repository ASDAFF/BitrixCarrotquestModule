<?
	...
	$MESS['OPTIONS_TRACK_PRODUCT_DETAILES'] = 'Track product details watch event';
	$MESS['OPTIONS_TRACK_ORDER_CONFIRM'] = 'Track order add event';
	$MESS['OPTIONS_KEYS'] = 'Key options';
