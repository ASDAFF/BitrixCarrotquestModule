...
* **CreateBackup** - Создает быэкап для шаблона в папке, путь к которой указан в константе CARROTQUEST_BACKUP_PATH.
* **CleaneBackups** - Очищает папку с бэкапами. Можно удалить все, или оставить последние.
